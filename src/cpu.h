...
class CPU {
   public:
    ...
    virtual ~CPU(){std::cout << "delete CPU from base" << std::endl;}
...
class RandomCPU : public CPU {
   public:
    ...
    ~RandomCPU(){std::cout << "delete random CPU from son" << std::endl;}
...
class StreamCPU : public CPU {
   public:
    using CPU::CPU;
    void ClockTick() override;
    ~StreamCPU(){std::cout << "delete stream CPU from son" << std::endl;}
